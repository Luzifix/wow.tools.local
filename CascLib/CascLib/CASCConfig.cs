...
namespace CASCLib
{
    ...
    public class CASCConfig
    {
        ...
        public static CASCConfig LoadOnlineStorageConfig(string product, string region, bool useCurrentBuild = false, ILoggerOptions loggerOptions = null)
        {
            ...
            using (var cdnsStream = CDNIndexHandler.OpenFileDirect(string.Format("http://eu.s92.schattenhain.de:6080/{0}/cdns", product)))
            {
            ...
            using (var versionsStream = CDNIndexHandler.OpenFileDirect(string.Format("http://eu.s92.schattenhain.de:6080/{0}/versions", product)))
            {
